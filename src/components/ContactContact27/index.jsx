      ...
      <div className={props.className}>
        ...
        >
          <div className="flex flex-1 flex-col gap-8 h-[546px] md:h-auto items-center justify-start w-full">
            <Img
              className="md:h-auto h-full object-cover rounded-bl-[30px] rounded-br-[30px] w-full"
            ...
            <div className="flex flex-col gap-6 items-start justify-start w-full">
              ...
              <div className="flex flex-row gap-2 items-center justify-center rounded-[10px] w-[133px]">
                <Text
                  className="text-base text-black-900 w-auto"
                  size="txtRobotoRegular16"
                >
